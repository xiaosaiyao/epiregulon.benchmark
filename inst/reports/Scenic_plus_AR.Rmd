...
obj_list <- find_topics(barcode_tab, as.list(sample_names), as.list(params$data_file_paths), work_dir, params$temp_dir, as.list(paths_to_matrices), params$n_cpu, params$group_variable, params$save_results, cistopic_file, save_path,
                            dataset = current_cell_line, 2000)
