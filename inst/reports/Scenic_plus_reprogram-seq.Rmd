...
cistopic_obj <- find_topics(adata, barcode_tab, sample_names = barcode_tab$sample_id[1], params$data_file_paths, params$work_dir, params$temp_dir, path_to_peak_matrix = as.list(path_to_peak_matrix), params$n_cpu, params$group_variable, "reprogram", 2000)
