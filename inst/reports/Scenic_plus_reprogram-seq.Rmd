...
eRegulons  <- run_scenicplus(barcode_tab, as.list(sample_names), as.list(params$data_file_paths), work_dir=params$work_dir, params$temp_dir,
                             as.list(paths_to_matrices), params$n_cpu, params$group_variable, params$save_results,
