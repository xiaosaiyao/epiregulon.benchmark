...
```{r child = "pruned_regulon_NGS4557.Rmd", warning = FALSE, cache = TRUE, cache.lazy = FALSE}
```
...
group_combinations_1 <- expand.grid(c("LNCaP"), c("ARV-110", "Enza"), "DMSO", "down", "AR")
group_combinations_2 <- expand.grid(c("LNCaP"), c("A9690"), "DMSO", "down", c("SMARCA2", "SMARCA4"))
...
weight_clusters <- as.list(c(corr = "Clusters_Combined", MI = "Clusters_Combined", lmfit = "Clusters_Combined", logFC = "Cellline", wilcoxon = "Cellline"))
...
```{r child = system.file("reports/FigR_AR.Rmd", package = "epiregulon.benchmark"), cache=TRUE, cache.lazy=FALSE}
```
