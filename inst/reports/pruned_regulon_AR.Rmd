...
if("LNCaP" %in% AR_cell_lines){
    ...
    if(params$save_results) saveRDS(regulon_df_full, file.path(save_path, "regulon_full_LNCaP.rds"))
    
    # prune network
    pruned.regulon_LNCaP <- pruneRegulon(regulon = regulon_df_full,
                                   expMatrix = GeneExpressionMatrix_LNCaP,
                                   exp_assay = "normalizedCounts",
                                   peakMatrix = peakMatrix_LNCaP,
                                   peak_assay = "counts",
...
if("VCaP" %in% AR_cell_lines){
    ...
    if(params$save_results) saveRDS(regulon_df_full, file.path(save_path, "regulon_full_VCaP.rds"))
    
    # prune network
    pruned.regulon_VCaP <- pruneRegulon(regulon = regulon_df_full,
                                   expMatrix = GeneExpressionMatrix_VCaP,
                                   exp_assay = "normalizedCounts",
                                   peakMatrix = peakMatrix_VCaP,
                                   peak_assay = "counts",
