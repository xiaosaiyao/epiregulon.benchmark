...
```{r child = "basic_simulation_stronger_chromatin_effect.Rmd"}
```
...
true_ranks_matrix <- readRDS("/gstore/scratch/u/wlodarct/true_ranks_matrix_2.rds")
transcription_difference_matrix <- readRDS("/gstore/scratch/u/wlodarct/transcription_difference_matrix_2.rds")
```
