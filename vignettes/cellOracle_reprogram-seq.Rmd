...
barcodes_list <- colnames(mae[["GeneExpressionMatrix"]])
barcodes_list <- gsub("reprogram#", "", barcodes_list)
HTO_list <- colData(mae[["GeneExpressionMatrix"]])$hash_assignment
```
```{r cache = TRUE}
adata <- get_annotated_data(barcodes_list, HTO_list)
