...
- activity calculated based on weights for all cells
- pruning clusters form lmfit, MI and corr are defined by hash assignment
...
########### Chanegd ###################
weight_clusters <- c(corr = "hash_assignment", MI = "hash_assignment", lmfit = "hash_assignment", logFC = "Cellline", wilcoxon = "Cellline")
